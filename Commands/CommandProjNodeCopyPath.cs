...
namespace MyCopyExtensionVs.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandProjNodeCopyPath
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CommandProjNodeCopyPath(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CommandProjNodeCopyPath Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new CommandProjNodeCopyPath(package, commandService);
        }
