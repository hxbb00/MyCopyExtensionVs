...
namespace MyCopyExtensionVs.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandFolderNodeCopyPath
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CommandFolderNodeCopyPath(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CommandFolderNodeCopyPath Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new CommandFolderNodeCopyPath(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            Clipboard.SetText(path.FullName.TrimEnd('\\', '/'));
        }
    }
}
