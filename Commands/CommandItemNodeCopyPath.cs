...
namespace MyCopyExtensionVs.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandItemNodeCopyPath
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CommandItemNodeCopyPath(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CommandItemNodeCopyPath Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new CommandItemNodeCopyPath(package, commandService);
        }
