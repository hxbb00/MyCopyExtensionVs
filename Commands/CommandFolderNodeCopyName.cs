...
namespace MyCopyExtensionVs.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandFolderNodeCopyName
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CommandFolderNodeCopyName(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CommandFolderNodeCopyName Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new CommandFolderNodeCopyName(package, commandService);
        }
