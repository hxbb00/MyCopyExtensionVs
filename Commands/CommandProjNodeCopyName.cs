...
namespace MyCopyExtensionVs.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandProjNodeCopyName
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CommandProjNodeCopyName(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CommandProjNodeCopyName Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new CommandProjNodeCopyName(package, commandService);
        }
