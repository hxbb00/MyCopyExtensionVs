...
namespace MyCopyExtensionVs.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandItemNodeCopyLinuxPath
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CommandItemNodeCopyLinuxPath(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CommandItemNodeCopyLinuxPath Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new CommandItemNodeCopyLinuxPath(package, commandService);
        }
