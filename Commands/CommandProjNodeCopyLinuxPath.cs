...
namespace MyCopyExtensionVs.Commands
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandProjNodeCopyLinuxPath
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CommandProjNodeCopyLinuxPath(AsyncPackage package, OleMenuCommandService commandService)
        {
        ...
        /// </summary>
        public static CommandProjNodeCopyLinuxPath Instance
        {
            get;
            private set;
        }
        ...
        public static async Task InitializeAsync(AsyncPackage package)
        {
            ...
            Instance = new CommandProjNodeCopyLinuxPath(package, commandService);
        }
        ...
        private void Execute(object sender, EventArgs e)
        {
            ...
            ClipboardTools.SetPathText(paths, true);
        }
    }
}
